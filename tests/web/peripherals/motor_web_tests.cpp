...
{
    motor_web->handle_action(
        {"/test/update?mode=forward&speed=50", "", rover::hal::HttpMethod::GET});
...
{
    motor_web->handle_action(
        {"/test/update?mode=reverse&speed=75", "", rover::hal::HttpMethod::GET});
...
{
    motor_web->handle_action({"/test/update?mode=off&speed=0", "", rover::hal::HttpMethod::GET});
...
{
    motor_web->handle_action({"/test/update?mode=forward", "", rover::hal::HttpMethod::GET});
